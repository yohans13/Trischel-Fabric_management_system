...
<div id="app1">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Y-First</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <router-link class="collapse-item" to="/show-employee"> All Employee</router-link>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap1" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          ...
          <router-link class="collapse-item" to="/store-supplier"> Add Suppliers</router-link>
            <router-link class="collapse-item" to="/show-supplier"> All Suppliers</router-link>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          ...
          <router-link class="collapse-item" to="/store-category"> Add Category</router-link>
            <router-link class="collapse-item" to="/show-category"> All Categorys</router-link>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap3" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          ...
          <router-link class="collapse-item" to="/store-product"> Add Products</router-link>
            <router-link class="collapse-item" to="/show-product"> All Products</router-link>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap4" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          ...
          <router-link class="collapse-item" to="/store-expense"> Add Expense</router-link>
            <router-link class="collapse-item" to="/show-expense"> All Expenses</router-link>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrap72"
          aria-expanded="true" aria-controls="collapseBootstrap72">
          <i class="fas fa-fw fa-columns"></i>
          <span>Orders</span>
        </a>
        <div id="collapseBootstrap72" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
        ...
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>copyright &copy; <script> document.write(new Date().getFullYear()); </script> - developed by
              <b><a href="https://github.com/yohans13" target="_blank">Yohan Perera</a></b>
            </span>
          </div>
        </div>
      </footer>
