                ...
                <div class="content-body">
                    ...
                    <div class="blog-detail-wrapper">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <img  v-bind:src="form.image"  class="img-fluid card-img-top" alt="Blog Detail Pic" />
                                    <div class="card-body">
                                        <h4 class="card-title">The Best Features Coming to iOS and Web design</h4>
                                        <div class="media">
                                            <div class="avatar mr-50">
                                                <img v-bind:src="form.image"  alt="Avatar" width="24" height="24" />
                                            </div>
                                        ...
                                        <div class="media">
                                            <div class="avatar mr-2">
                                                <img  v-bind:src="form.image"  width="60" height="60" alt="Avatar" />
                                            </div>
                                            <div class="media-body">
                            ...
                            <div class="mt-75">
                                <div class="media mb-2">
                                    <a href="page-blog-detail.html" class="mr-2">
                                        <img class="rounded"  v-bind:src="form.image"  width="100" height="70" alt="Recent Post Pic" />
                                    </a>
                                    <div class="media-body">
