<template>
  ...
  <div>
    <router-link to="/show-product" class="btn btn-primary">All Product</router-link>
  </div>
                   ...
                   <form class="user" @submit.prevent="productUpdate" enctype="multipart/form-data" >
                      ...
                      <div class="form-group">
                            ...
                            <div  class="form-row">
                              ...
                              <div class="col-md-6">
                                       <label for="select1">Product Code</label>
                      ...
                      <div class="form-group">
                            ...
                            <div  class="form-row">
                                <div class="col-md-6">
                                       ...
                                       <label for="select1">Product Category</label>
                              ...
                              <div class="col-md-6">
                                  <label for="select1">Product Supplier</label>
                                       <select  class="form-control" id="select1" v-model="form.supplier_id" >
                      ...
                      <div class="form-group">
                            ...
                            <div  class="form-row">
                                <div class="col-md-4">
                                       <label for="select1">Product Root</label>
                                ...
                                <div class="col-md-4">
                                       <label for="select1">Buying Price</label>
                      ...
                      <div class="form-group">
                            ...
                            <div  class="form-row">
                                <div class="col-md-6">
                                       <label for="select1">Buying Date</label>
                              ...
                              <div class="col-md-6">
                                       <label for="select1">product quantity</label>
                            ...
                            <div  class="form-row">
                              ...
                              <div class="col-md-6">
                                <img :src="form.image" alt="Img" style="height:40px; width:40px;">
                              </div>
                            </div>
                ...
                data(){
                  return {
                   ...
                   created(){
                    ...
                    axios.get('/api/productSelect/'+id)
                  ...
                  methods:{
                    ...
                    let id =this.$route.params.id
                        ...
                        axios.patch('/api/productUpdate/'+id,this.form)
                        .then(()=>{
