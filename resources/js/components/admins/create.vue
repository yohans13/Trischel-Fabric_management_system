                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <router-link to="/show-admin" class="btn btn-primary">All Admins</router-link>

                                </div>
                                <div class="card-body">

                                    <form class="form" @submit.prevent="admimInsert" enctype="multipart/form-data">
                                        <div class="row">
  ...
  export default{
                ...
                data(){
                  ...
                  methods:{
                    ...
                    admimInsert(){
                        axios.post('/api/adminStore',this.form)
                        .then(()=>{
