                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">All Admins Details</h4>
                                 <router-link to="/store-user" class="btn btn-primary">Add Admin</router-link>
                            </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr v-for="user in filtersearch" :key="user.id" >
                                            ...
                                            <td> &nbsp&nbsp 
                                                       <router-link  :to="{name:'edit-admin' ,params:{id:user.id}}" > 
                ...
                deleteUser(id){
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                          ...
                          axios.delete('/api/adminDelete/'+id)
                            .then(() =>{
                            ...
                            .catch(()=>{
                              this.$route.push({name:'show-admin'})
                            })
                          Swal.fire(
                          'Deleted!',
