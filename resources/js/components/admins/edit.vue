                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <router-link to="/show-user" class="btn btn-primary">All Admins</router-link>

                                </div>
                                <div class="card-body">

                                    <form class="form" @submit.prevent="adminUpdate" enctype="multipart/form-data">
                                        <div class="row">
                                          ...
                                          <div class="col-md-6 col-12">
                                            ...
                                            <div class="media">
                                                ...
                                                <img :src="'/'+ form.photo" class="rounded mr-50" alt="profile image" height="80" width="100"  id="em_photo">
                ...
                data(){
                  ...
                  methods:{
                    ...
                    let id =this.$route.params.id
                        ...
                        axios.patch('/api/adminUpdate/'+id,this.form)
                        .then(()=>{
                          this.$router.push({name:'show-admin'})
                          Notification.success()
