<template>
  ...
  <div>
    <router-link to="/show-supplier" class="btn btn-primary">All Suppliers</router-link>
  </div>
                ...
                data(){
                  return {
                   ...
                   created(){
                    ...
                    axios.get('/api/supplierSelect/'+id)
                  ...
                  methods:{
                    ...
                    let id =this.$route.params.id
                        ...
                        axios.patch('/api/supplierUpdate/'+id,this.form)
                        .then(()=>{
                          this.$router.push({name:'show-supplier'})
