                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                            ...
                                            <div class="media">
                                                <a href="javascript:void(0);" class="mr-25">
                                                    <img v-bind:src="form.postprofile" id="account-upload-img" class="rounded mr-50" alt="profile image" height="80" width="80" />
                                                </a>
...
export default {
   ...
   data(){
                  return {
                    ...
                    profile: 'vbackend/app-assets/images/portrait/small/avatar-s-2.jpg',
                    postprofile: 'vbackend/app-assets/images/portrait/small/avatar-s-2.jpg',
