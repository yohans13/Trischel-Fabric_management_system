          ...
          <div class="row mb-3"> 
                ...
                <div class="col-xl-5 col-lg-5">
                      <div class="card mb-4">
                        ...
                        <a href="/store-customer" class="btn btn-info">Add Customer</a>
                        </div>
                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      <tr v-for="cart in carts" :key="cart.id">
                        <td>{{cart.pro_name}}</td>
                        <td><input style="width:25px; border:1px solid lightgray;" type="text" readonly="" :value="cart.pro_quantity">
                        <button class="btn btn-success" @click.prevent="increment(cart.id)">+</button>
                        <button class="btn btn-danger" @click.prevent="decrement(cart.id)" v-if="cart.pro_quantity >=2 ">-</button>
                        <button class="btn btn-danger" @click.prevent="decrement(cart.id)" v-else Disabled >-</button>
                ...
                <div class="card-footer" style="font-size:16px;">
                  ...
                  <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">Total Amount: <strong>{{subtotal*vats.vat /100 + subtotal}}$</strong> </li>
                  </ul>
                          ...
                          <div class="card mb-4">
                              ...
                              <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    ...
                                    <div class="card-body">
                                      <input type="text" v-model="searchTerm" placeholder="Search Product" class="form-control" style="width:550px;"> 
                                        <br>
                                          <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-6  col-6" v-for="product in filtersearch" :key="product.id"> 
                                                <button class="btn btn-sm" @click.prevent="AddToCart(product.id)">
                                                    <div class="card" style="width: 8.5rem; margin-bottom:7px;" >
                                      ...
                                      <div class="card-body">
                                        <input type="text" v-model="getsearchTerm" placeholder="Search Product" class="form-control" style="width:550px;"> 
                                        <br>
                                          <div class="row">
...
<script type="text/javascript">
   export default{
                ...
                methods:{
                  ...
                  //add cart product(get from post table)
                  CartProduct()
                  {
