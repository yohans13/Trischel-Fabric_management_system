                  ...
                  <div class="login-form">
                   ...
                   <form class="user" @submit.prevent="customerInsert" enctype="multipart/form-data" >
                      ...
                      <div class="form-group">
                            ...
                            <div  class="form-row">
                                <div class="col-md-6">
                                     <label for="details"><b>Customer Name</b></label>
                              ...
                              <div class="col-md-6">
                                     <label for="details"><b>Customer Email</b></label>
                      ...
                      <div class="form-group">
                            ...
                            <div  class="form-row">
                                <div class="col-md-6">
                                     <label for="details"><b>Customer Address</b></label>
                                ...
                                <div  class="form-row">
                                <div class="col-md-6">
                                     <label for="details"><b>Customer Phone Number</b></label>
   ...
   export default{
                ...
                data(){
                  ...
                  methods:{
                    ...
                    customerInsert(){
                        axios.post('/api/customerStore',this.form)
                        .then(()=>{
