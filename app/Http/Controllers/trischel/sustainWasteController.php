...
class sustainWasteController extends Controller
{
    ...
    public function WasteSelect($id)
    {
        $waste =DB::table('sustainabilities')->where('id',$id)->first();
    ...
    public function getyears(){
        $sus = DB::table('sustainabilities')->select('year')->where('mainName','WASTE')->groupBy('year')->orderBy('year','DESC')->get();
    ...
    public function getWaste(){
        ...
        $waste=DB::table('sustainabilities')
        ->where('mainName','WASTE')->where('year','2021')->get();
        return response()->json($waste);
    }
    ...
    public function updateYear($year){
        ...
        ->where('mainName','WASTE')->where('year',$year)->get();
    ...
    public function WasteDelete($id)
    {
