...
class sustainProductionController extends Controller
{
    ...
    public function ProductionSelect($id)
    {
        $production =DB::table('sustainabilities')->where('id',$id)->first();
    ...
    public function getyears(){
        $sus = DB::table('sustainabilities')->select('year')->where('mainName','PRODUCTION')->groupBy('year')->orderBy('year','DESC')->get();
    ...
    public function getProduction(){
        ...
        $production=DB::table('sustainabilities')
        ->where('mainName','PRODUCTION')->where('year','2021')->get();
        return response()->json($production);
    }
    ...
    public function updateYear($year){
        ...
        ->where('mainName','PRODUCTION')->where('year',$year)->get();
