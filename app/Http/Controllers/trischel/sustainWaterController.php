...
class sustainWaterController extends Controller
{
    ...
    public function WaterSelect($id)
    {
        $water =DB::table('sustainabilities')->where('id',$id)->first();
    ...
    public function getyears(){
        $sus = DB::table('sustainabilities')->select('year')->where('mainName','WATER')->groupBy('year')->orderBy('year','DESC')->get();
    ...
    public function getWater(){
        ...
        $water=DB::table('sustainabilities')
        ->where('mainName','WATER')->where('year','2021')->get();
        return response()->json($water);
    }
    ...
    public function updateYear($year){
        ...
        ->where('mainName','WATER')->where('year',$year)->get();
    ...
    public function WaterDelete($id)
    {
